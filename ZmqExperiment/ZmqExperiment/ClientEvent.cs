  ...
  static ClientEventReflection() {
    ...
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        ...
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::ClientEventsSubscribeRequest), global::ClientEventsSubscribeRequest.Parser, new[]{ "Subscriptions", "LastKnownBlockIds" }, null, null, null, null),
          new pbr::GeneratedClrTypeInfo(typeof(global::ClientEventsSubscribeResponse), global::ClientEventsSubscribeResponse.Parser, new[]{ "Status", "ResponseMessage" }, null, new[]{ typeof(global::ClientEventsSubscribeResponse.Types.Status) }, null, null),
          new pbr::GeneratedClrTypeInfo(typeof(global::ClientEventsUnsubscribeRequest), global::ClientEventsUnsubscribeRequest.Parser, null, null, null, null, null),
          new pbr::GeneratedClrTypeInfo(typeof(global::ClientEventsUnsubscribeResponse), global::ClientEventsUnsubscribeResponse.Parser, new[]{ "Status" }, null, new[]{ typeof(global::ClientEventsUnsubscribeResponse.Types.Status) }, null, null),
          new pbr::GeneratedClrTypeInfo(typeof(global::ClientEventsGetRequest), global::ClientEventsGetRequest.Parser, new[]{ "Subscriptions", "BlockIds" }, null, null, null, null),
          new pbr::GeneratedClrTypeInfo(typeof(global::ClientEventsGetResponse), global::ClientEventsGetResponse.Parser, new[]{ "Status", "Events" }, null, new[]{ typeof(global::ClientEventsGetResponse.Types.Status) }, null, null)
        }));
  }
  #endregion
...
#endif
{
  ...
  void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
    ...
    lastKnownBlockIds_.WriteTo(ref output, _repeated_lastKnownBlockIds_codec);
    if (_unknownFields != null) {
  ...
  void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 18: {
          lastKnownBlockIds_.AddEntriesFrom(ref input, _repeated_lastKnownBlockIds_codec);
          break;
        }
      }
    }
...
#endif
{
  ...
  private global::ClientEventsSubscribeResponse.Types.Status status_ = global::ClientEventsSubscribeResponse.Types.Status.Unset;
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
  ...
  public override int GetHashCode() {
    int hash = 1;
    if (Status != global::ClientEventsSubscribeResponse.Types.Status.Unset) hash ^= Status.GetHashCode();
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    output.WriteRawMessage(this);
  #else
    if (Status != global::ClientEventsSubscribeResponse.Types.Status.Unset) {
  ...
  public void MergeFrom(ClientEventsSubscribeResponse other) {
    ...
    if (other.Status != global::ClientEventsSubscribeResponse.Types.Status.Unset) {
      Status = other.Status;
    }
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        default:
          ...
          break;
        case 8: {
          Status = (global::ClientEventsSubscribeResponse.Types.Status) input.ReadEnum();
          break;
        }
        case 18: {
...
#endif
{
  ...
  /// <summary>Field number for the "status" field.</summary>
  public const int StatusFieldNumber = 1;
  private global::ClientEventsUnsubscribeResponse.Types.Status status_ = global::ClientEventsUnsubscribeResponse.Types.Status.Unset;
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
  ...
  public override int GetHashCode() {
    int hash = 1;
    if (Status != global::ClientEventsUnsubscribeResponse.Types.Status.Unset) hash ^= Status.GetHashCode();
    if (_unknownFields != null) {
      hash ^= _unknownFields.GetHashCode();
    }
    return hash;
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    output.WriteRawMessage(this);
  #else
    if (Status != global::ClientEventsUnsubscribeResponse.Types.Status.Unset) {
      output.WriteRawTag(8);
      output.WriteEnum((int) Status);
    }
    if (_unknownFields != null) {
  ...
  public void MergeFrom(ClientEventsUnsubscribeResponse other) {
    ...
    if (other.Status != global::ClientEventsUnsubscribeResponse.Types.Status.Unset) {
      Status = other.Status;
    }
    _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
  }
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        default:
          ...
          break;
        case 8: {
          Status = (global::ClientEventsUnsubscribeResponse.Types.Status) input.ReadEnum();
          break;
        }
      }
    }
...
#endif
{
  ...
  void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
    subscriptions_.WriteTo(ref output, _repeated_subscriptions_codec);
    blockIds_.WriteTo(ref output, _repeated_blockIds_codec);
    if (_unknownFields != null) {
      _unknownFields.WriteTo(ref output);
    }
  }
  ...
  void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        ...
        case 18: {
          blockIds_.AddEntriesFrom(ref input, _repeated_blockIds_codec);
          break;
        }
      }
    }
...
#endif
{
  ...
  /// <summary>Field number for the "status" field.</summary>
  public const int StatusFieldNumber = 1;
  private global::ClientEventsGetResponse.Types.Status status_ = global::ClientEventsGetResponse.Types.Status.Unset;
  [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
  [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
  ...
  public override int GetHashCode() {
    int hash = 1;
    if (Status != global::ClientEventsGetResponse.Types.Status.Unset) hash ^= Status.GetHashCode();
  ...
  public void WriteTo(pb::CodedOutputStream output) {
    ...
    output.WriteRawMessage(this);
  #else
    if (Status != global::ClientEventsGetResponse.Types.Status.Unset) {
      output.WriteRawTag(8);
      output.WriteEnum((int) Status);
    }
  ...
  public void MergeFrom(ClientEventsGetResponse other) {
    ...
    if (other.Status != global::ClientEventsGetResponse.Types.Status.Unset) {
      Status = other.Status;
    }
    ...
    while ((tag = input.ReadTag()) != 0) {
      switch(tag) {
        default:
          ...
          break;
        case 8: {
          Status = (global::ClientEventsGetResponse.Types.Status) input.ReadEnum();
          break;
        }
        case 18: {
